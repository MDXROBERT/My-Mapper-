...
(define tube (list "Northen" "Jubilee" "Victoria" "Waterloo&City"))
...
(define Jubilee (unweighted-graph/undirected '(
("Stanmore" "Canons Park")
("Canons Park" "Queensbury")
("Queensbury" "Kingsbury")
("Kingsbury" "Wembley Park")
...
(define Waterloo&City (unweighted-graph/undirected '("Waterloo" "Bank")))
